...
const (
	...
	ContainerRuntimeEnv = "APPTEST_FN_RUNTIME"
...
func (f *ContainerFn) runCLI(reader io.Reader, writer io.Writer, bin string, filterCLIOutputFn func(io.Reader) string) error {
	//func (f *ContainerFn) runCLI(inFile string, writer io.Writer, bin string, filterCLIOutputFn func(io.Reader) string) error {
